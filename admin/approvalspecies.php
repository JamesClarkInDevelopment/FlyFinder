<?php
	...
	//ADMIN SECTION
	//Page to show results by species
	$getcat = $conn->real_escape_string($_GET['filter']);
	
	$read="SELECT * FROM FLY_UserUploads  WHERE ApprovalID = 2 AND SpeciesID = '$getcat' ;";
...
<html>
	<head>
		...
		<title>Admin Approval Species</title>
			...
			<div class="row  text-center" >
				...
				<?php
						...
						while($row =$result->fetch_assoc()){
								//shows results by chosen species
