...
session_start();
	...
	//gives the user an option to edit their upload
	...
	//several querires to populate the forms
	...
	$readupload = "SELECT * FROM FLY_UserUploads WHERE UploadID = '$getID'";
	$resultupload = $conn->query($readupload);
	if(!$readupload){
		echo$conn->error;
	}
	
	$row1 = $resultupload->fetch_assoc();
	$ID = $row1['UploadID'];
...
<html>
	<head>
		...
		<title>FlyFinder Edit Upload </title>
	...
	<body class="backgroundlogout">
		...
		<div class="container-fluid">
			<div class="row">
				...
				<h2 class="display-3 text-light font-italic">Update Spotting</h2>
				<?php echo "<form action='uploadedited.php?uploadID=$ID' method='POST' enctype='multipart/form-data'>"?>
					<div class="row justify-content-md-center ">
						...
						?>
							...
							placeholder='Change Your Description' type="text" required ></textarea>
							...
							<?php
								//if the member is an enthusiast they can edit the further details below
							...
							?>
									<script>
										...
										//code implemented/edited from w3school.com (referenced in dissertation appendix)
