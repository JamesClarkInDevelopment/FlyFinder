<?php
	...
	$userread ="SELECT * FROM FLY_UserUploads WHERE ApprovalID = 1 AND UserID = '$getID'";
	...
	WHERE ApprovalID = 1  ORDER BY TimeOfYear ASC;";
...
<html>
	...
	<body class="backgroundsearch">
		...
		<h2 class="display-3 text-light text-center font-italic" >All Uploads from <?php echo $username;  ?> </h2>
