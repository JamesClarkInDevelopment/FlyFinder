<?php
	...
	$speciesread ="SELECT * FROM FLY_UserUploads INNER JOIN FLY_User ON FLY_User.UserID = FLY_UserUploads.UserID WHERE ApprovalID = 1 AND SpeciesID = '$getID'  ORDER BY Likes DESC";
...
<html>
	...
	<body class="backgroundsearch">
		...
		<h2 class="display-3 text-light text-center font-italic" >All <?php echo $specsearch ?> Uploads </h2>
		<div class="container-fluid" id="width80">
			<div class="row" id="filler">
			</div>
			<div class="row">
				<div class='col-3 text-center '>
					<a href='viewall.php' class='btn btn-outline-light btn-lg' role='button' aria-disabled='true'>Search Home</a>
				</div>
				<div class='col-3 text-center '>
