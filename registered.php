<?php
	...
	//checks if the username already exists and sets $taken for the output to the screen if a result is returned
	$usernamecheck = "SELECT * FROM FLY_User WHERE Username = '$user';";
	$resultcheck= $conn -> query($usernamecheck);
		...
		<div class="container-fluid">
			<div class="row">
				<div class="col-8 text-center">
					...
					$resultcheck= $conn -> query($usernamecheck);
					if ($resultcheck->num_rows > 0){
						echo"<h2 class='display-4 text-light text-center '>Username Already Taken </h2>
						<a class='btn btn-light center'  href='register.php' role='button'>BACK</a>";
					} else{
				...
				echo"<h3 class='display-5 text-light text-center '> Thanks for Joining FlyFinder! </h3>
				...
				<div class='col-4'>
					  <img src='customerimages/$filename' id='registered'>
				</div>";
				}
			?>
			</div>
